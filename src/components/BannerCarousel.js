            ...
            {videos.map((video, index) => (
              <div key={index} className="flex justify-center p-4">
                <div className="bg-transparent p-4 rounded shadow-md flex justify-around ">
                    <div>
                        <div className="">
                    <p className="text-2xl font-bold mb-4 py-2 px-4 rounded-md text-white w-1/2">{video.category}</p>
                  </div>

                  <div className="w-1/2 pr-4">
                    <h2 className="text-2xl font-bold mb-4 py-2 px-4 rounded-md text-white">{video.title}</h2>
                  ...
                  <div className="w-1/2 content-center">
                    <div className="rounded">
                      <img src={video.image} alt={video.category} />
                    </div>
                  </div>
                </div>
              </div>
