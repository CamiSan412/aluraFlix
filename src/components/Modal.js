...
const Modal = ({ showModal, setShowModal, video, handleEditVideo }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white p-6 rounded shadow-md w-96">
        ...
        <button onClick={() => setShowModal(false)} className="absolute top-2 right-2 bg-red-600 text-white px-2 py-1 rounded">
          Cerrar
        </button>
      </div>
    </div>
